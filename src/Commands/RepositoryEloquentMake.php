...
class RepositoryEloquentMake extends GeneratorCommand
{
    /**
    ...
    /**
     * Create a mapper for the eloquent repository.
     *
     * @return void
     */
    protected function createMapper()
    {
        $this->call('make:mapper:eloquent', [
    ...
    protected function getPath($name)
    {
        ...
        return $this->laravel['path'] . '/' . str_replace('\\', '/', $name) . 'Eloquent.php';
    }
    ...
    {
        return [
            ['all', 'a', InputOption::VALUE_NONE, 'Generate a use case for the eloquent repository'],

            ['mapper', 'm', InputOption::VALUE_NONE, 'Generate a mapper for the eloquent repository'],

            ['force', null, InputOption::VALUE_NONE, 'Create the class even if the eloquent repository already exists.'],
        ];
    }
}
